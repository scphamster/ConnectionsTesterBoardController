...
set(C_CXX_COMPILE_FLAGS "${COMPILER_WARNINGS_SETTINGS} ${BOARD_CONFIGS_COMPILE_FLAGS} ${COMPILER_SHOW_HEADERS_CMD} ${C_CXX_CONDITIONAL_COMPILE_FLAGS} ${FPU_SETTINGS_COMPILE_FLAGS} --param max-inline-insns-single=500 -ffunction-sections -c")
set(C_COMPILE_FLAGS "-x c -std=gnu11")
set(CXX_COMPILE_FLAGS "${CXX_CONDITIONAL_COMPILE_FLAGS} -fno-exceptions -std=gnu++23")
