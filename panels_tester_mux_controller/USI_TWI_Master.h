...
// The factor of 1 million is left in there until the very end to prevent integer math effects from building on each
// other. Rounding factor is the amounnt added after the rest of calculationr to the intermediate value before dividing by
// 1 million
...
// This is already pulled in by Arduino.h on ATTinyCore. If it's not coming through correctly via Arduino.h, we're fucked
// anyway. because this library **requires** the defines derived from it.
